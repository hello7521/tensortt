...
model = torch.hub.load(r'D:\TEN\yolov5', 'custom', path=r'D:\TEN\half.engine', source="local").eval().cuda()
model.conf = 0.5
model.maxdet = 10
model.apm = True 
model.classes = [0]

camera = dxcam.create(device_idx=0,output_idx=0, output_color="BGR")  # normal color
